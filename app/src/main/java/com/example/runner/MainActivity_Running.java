...
public class MainActivity_Running extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainActivity_Running.this.startForegroundService(intent);
        bindService(
        ...
        MainActivity_Running.this.registerReceiver(receiver,filter);
        chronometer =(Chronometer) findViewById(R.id.chronometer);
        SetListeners();
    }

    /**
     * Once the data update make it shown on screen
     */
       ...
       //stop timing
        ...
        finishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity_Running.this);
                ...
                builder.setPositiveButton("Continue", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(MainActivity_Running.this,R.string.toastMessage,
